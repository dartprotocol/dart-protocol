...
[![CI](https://github.com/dartprotocol/dart-protocol/actions/workflows/ci.yml/badge.svg)](https://github.com/dartprotocol/dart-protocol/actions/workflows/ci.yml)
[![Website](https://img.shields.io/badge/website-GitHub%20Pages-blue.svg)](https://dartprotocol.github.io/dart-protocol/)
...
- [ ] **Browser WebTransport (V2)** — replace the TCP/WebSocket bridge with QUIC datagrams so the browser gets true UDP semantics (see the V2 page on [the website](https://dartprotocol.github.io/dart-protocol/v2.html)).
...
lives on [GitHub Pages](https://dartprotocol.github.io/dart-protocol/).
